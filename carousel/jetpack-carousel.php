	...
	function enqueue_assets( $output ) {
		...
		if ( $this->first_run ) {
			...
			$localize_strings = array(
				...
				'download_original'    => sprintf( __( 'Vollst&auml;ndige Gr&ouml;&szlig;e anzeigen <span class="photo-size">%1$s<span class="photo-size-times">&times;</span>%2$s</span>', 'jetpack' ), '{0}', '{1}' ),
